...
- Direct WFIGS loading avoids maintaining another publication pipeline and keeps incidents timely, but availability depends on the official ArcGIS service. In-memory geometry reuse, bounded retries, partial refresh, and old-layer retention mitigate transient failures.
